...
The shared AI service uses `qwen3:4b` as the primary local answer model, `gemma3:4b` as local fallback, `intfloat/multilingual-e5-base` for embeddings, and `BAAI/bge-reranker-v2-m3` for CPU reranking.
